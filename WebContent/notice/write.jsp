    	...
    	<div class="row">
			...
			<form method = "post" name="f" action = "save.jsp">
					  ...
					  <div class="text-right" style="margin-bottom : 20px;">
					    <a href="http://www.naver.com" id="saveNotice" class="btn btn-outline-danger">저장</a>
					    <a href="list.jsp?page=<%=cPage %>" class="btn btn-outline-danger">등록</a>					    
					  </div>
	        </div>
        </div>
    </div>
    <script>
    	$(function() {
    		$("#saveNotice").click(function(e) {
    			//a 기능은 href 속성에 있는 주소로 이동하는데 이런 기능을 제거한다는 의미 ->action = "save.jsp"로 이동
    			e.preventDefault();
